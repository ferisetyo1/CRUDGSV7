...
mixin _$AppState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(T data, int? total, bool? hasReachedMax) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(T data, int? total, bool? hasReachedMax)? success,
...
abstract class _Initial<T> extends AppState<T> {
...
class __$$NoConnectionImplCopyWithImpl<T, $Res>
    extends _$AppStateCopyWithImpl<T, $Res, _$NoConnectionImpl<T>>
...
class _$NoConnectionImpl<T> extends _NoConnection<T> {
  ...
  @override
  String toString() {
    return 'AppState<$T>.noConnection()';
  }
...
abstract class _NoConnection<T> extends AppState<T> {
...
abstract class _$$SuccessImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({T data, int? total, bool? hasReachedMax});
}
...
class _$SuccessImpl<T> extends _Success<T> {
  const _$SuccessImpl(this.data, {this.total, this.hasReachedMax}) : super._();
  ...
  @override
  String toString() {
    return 'AppState<$T>.success(data: $data, total: $total, hasReachedMax: $hasReachedMax)';
  }
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(data), total, hasReachedMax);
  ...
  TResult when<TResult extends Object?>({
    ...
    return success(data, total, hasReachedMax);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return success?.call(data, total, hasReachedMax);
  }
...
abstract class _Success<T> extends AppState<T> {
  const factory _Success(final T data,
      {final int? total, final bool? hasReachedMax}) = _$SuccessImpl<T>;
...
abstract class _Empty<T> extends AppState<T> {
